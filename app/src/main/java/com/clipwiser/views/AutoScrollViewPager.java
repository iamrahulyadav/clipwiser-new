       ...
       /* int dragthreshold = 30;
        ...
        if (stopScrollWhenTouch) {
            if ((action == MotionEvent.ACTION_DOWN) && isAutoScroll) {
                /*downX1 = (int) ev.getRawX();
                downY1 = (int) ev.getRawY();*/
                isStopByTouch = true;
                stopAutoScroll();
               /* getParent().requestDisallowInterceptTouchEvent(false);*/
                ...
                startAutoScroll();
               // getParent().requestDisallowInterceptTouchEvent(false);
            } /*else if (ev.getAction() == MotionEvent.ACTION_MOVE && isAutoScroll) {
                int distanceX = Math.abs((int) ev.getRawX() - downX1);
                int distanceY = Math.abs((int) ev.getRawY() - downY1);
