...
public  class ClipAdapter
        extends RecyclerView.Adapter< ClipAdapter.ViewHolderMain > {
    ...
    public ClipAdapter( Context context, List< String > items ) {
    ...
    public ViewHolderMain onCreateViewHolder( ViewGroup parent, int viewType ) {
        View view = LayoutInflater.from( parent.getContext() )
                .inflate( R.layout.itemview_product, parent, false );
...
//        holder.textViewLastChat.setText( mValues.get( position ) );
        ...
        if(position %2== 0)
            Glide.with( context )
                    .load( R.drawable.dummy_women_image )
                    .into( holder.imageviewItemChatListMain );
        else
            Glide.with( context )
                    .load( R.drawable.dummy_men_shirts )
                    .into( holder.imageviewItemChatListMain );
    }
...
//            relativeLayoutRootMainChatlist = ( RelativeLayout ) itemView.findViewById( R.id.relativeLayoutRootMainChatlist );
            imageviewItemChatListMain = ( AppCompatImageView ) itemView.findViewById( R.id.imageViewProductListItem );
