...
//	private DotProgressBar dotProgressbarLoadMore;
	...
	@BindView(R.id.textViewSkipWelcome)
	AppCompatTextView textViewSkipWelcome;

	@BindView( R.id.viewpagerImageSlidingWelcome )
	...
	@OnClick(R.id.textViewSkipWelcome)
	protected void openHomeScreen(){
		Intent intentHome = new Intent( this,WelcomeActivity.class );
		startActivity( intentHome );
	}
